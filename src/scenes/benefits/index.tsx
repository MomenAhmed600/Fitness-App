...
const benefits: Array<BenefitType> = [
  {
    ...
    description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora unde incidunt laborum, ut sit consectetur quos."
  },
  {
    ...
    <section
      ...
      >
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="visible"
          // onViewportEnter={{ once: true, amount: 0.5 }}
          viewport={{ once: true, amount: 0.5 }}
          variants={container}
        >
